...
public class AuthenticationApplication {
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(AuthenticationApplication.class, args);//creates a container in jvm containing all the objects specified as @Component
